...
class phaseShiftSetup(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_skiphead_0 = blocks.skiphead(gr.sizeof_float*1, 4096)
        ...
        self.blocks_head_0 = blocks.head(gr.sizeof_float*1, (1024*4))
        ...
        # Connections
        ##################################################
        self.connect((self.blocks_complex_to_arg_0, 0), (self.blocks_interleave_0, 0))
        self.connect((self.blocks_complex_to_arg_0_0, 0), (self.blocks_interleave_0, 1))
        self.connect((self.blocks_complex_to_arg_1, 0), (self.blocks_interleave_0, 2))
        self.connect((self.blocks_complex_to_arg_2, 0), (self.blocks_interleave_0, 3))
        ...
        self.connect((self.blocks_multiply_xx_0_0, 0), (self.blocks_complex_to_arg_1, 0))
        self.connect((self.blocks_multiply_xx_1, 0), (self.blocks_complex_to_arg_0_0, 0))
        self.connect((self.blocks_multiply_xx_1_0, 0), (self.blocks_complex_to_arg_2, 0))
