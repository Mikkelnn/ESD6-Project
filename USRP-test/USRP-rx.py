...
class USRP-rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "USRP-rx")
        ...
        self.uhd_usrp_source_0.set_center_freq(433125000, 0)
...
def main(top_block_cls=USRP-rx, options=None):
