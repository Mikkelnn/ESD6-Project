...
range_doppler = proc.range_doppler_fft(baseband, rwin=range_window, dwin=doppler_window, rn=256, dn=128) # 
...
unambiguous_speed = (3e8 / radar.radar_prop["transmitter"].waveform_prop["prp"][0] / f_c / 2)
